package SERVICES;
import MODEL.Players; // Lưu ý: Nếu class của Mạnh tên là Player (không s), bạn xóa chữ s đi nhé
...
public class SalaryCalculator {
    ...
    public double computeFinalSalary(Players p) {
    ...
    public double computeTotalBonus(Players p) {
    ...
    public double computeTotalPayout(Players p) {
